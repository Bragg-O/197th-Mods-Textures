...
fn_r14 = {
	while { true } do {
		...
		playSound3D [selectRandom ["\CIM_Core\MainMenu\data\r14_1.ogg", "\CIM_Core\MainMenu\data\r14_2.ogg", "\CIM_Core\MainMenu\data\r14_3.ogg"], m1, true, getPosATL m1, 2];
			...
			case 0 : {
				for "_i" from 0 to 1500 do {
					...
					if ((g1 inArea gonk_0) && (random 1 > 0.85)) then {
						playSound3D ["\CIM_Core\MainMenu\data\gonk_1.ogg", g1, true, getPosASL g1, 0.5];
					};
			...
			case 3 : {
				for "_i" from 0 to 1500 do {
					...
					if ((g4 inArea gonk_0) && (random 1 > 0.9)) then {
						playSound3D ["\CIM_Core\MainMenu\data\b1_1.ogg", g1, true, getPosASL g1, 0.5];
					};

...
if ( isNil {uiNamespace getVariable "extDB_SQL_CUSTOM_ID"}) then
{
	...
	private _database = "cim"; // This is case sensitive
	...
	_result = call compile ("extDB3" callExtension format["9:ADD_DATABASE_PROTOCOL:%1:SQL_CUSTOM:CUSTOM:requete.ini", _database]);

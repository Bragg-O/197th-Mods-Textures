class CIM_Dialog_GestPreset
{
	...
	class Controls
	{
		class presetList
		{
			...
			onLBSelChanged = "[] spawn DIALOG_fnc_updateGestPreset;";
		};
		class NewPreset
		{
			type = 1;
			idc = 1001;
			x = safeZoneX + safeZoneW * 0.31458334;
			y = safeZoneY + safeZoneH * 0.66296297;
			w = safeZoneW * 0.16510417;
			h = safeZoneH * 0.02222223;
			style = 0 + 2;
			text = "Nouveau preset";
			...
			onButtonClick = "['New'] spawn DIALOG_fnc_GestPreset;";
			shadow = 0;
		};
		class Exit
		{
		...
		class LoadPreset
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape", 0.09, 1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush", 0.09, 1.0};
			onButtonClick = "['Load'] spawn DIALOG_fnc_GestPreset;";
			shadow = 0;
		};
		class DeletePreset
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape", 0.09, 1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush", 0.09, 1.0};
			onButtonClick = "['Delete'] spawn DIALOG_fnc_GestPreset;";
			shadow = 0;
		};
		class Name
		{

...
private _NewCard = [_SabaccTable, _Color, _PlayerNumber] call SABACC_fnc_getNewCard;
...
[(parseText format["<t size='1.25' color='#ff0000'>Table de Sabacc</t><br/>tu a piocher la carte :<br/><t size='7'><img image='cim_sabacc\data\Cards\%1-%2.paa'/></t><br/><t color='%3'>%4</t>.",
	_NewCard select 0,
	_Colorlettre,
	_ColorText,
	[_NewCard select 0, _Color] call SABACC_fnc_getCardName
])] remoteExec ["hintSilent", _player];

...
class 197th_Bison_MGS: OPTRE_M413_MGS_UNSC
{
	displayName="[197th] Bison (MGS)";
	author = "[CIM] Bragg";
	scope=2;
	scopeCurator=2;
	...
	{
		"197th_Regs\Vehicules\Bison\Data\Body_co.paa",
		"197th_Regs\Vehicules\Bison\Data\Misc_co.paa",
...
class 197th_Bison_IFV: OPTRE_M412_IFV_UNSC
{
	displayName="[197th] Bison (IFV)";
	author = "[CIM] Bragg";
	scope=2;
	scopeCurator=2;
	crew="197th_Unit_Regs_Trooper";
...
class 197th_Bison_APC: OPTRE_M411_APC_UNSC
{
	displayName="[197th] Bison (APC)";
	author = "[CIM] Bragg";
	scope=2;
	scopeCurator=2;
	crew="197th_Unit_Regs_Trooper";

...
comment "Add weapons";
this addWeapon "JLTS_E5C";
this addPrimaryWeaponItem "JLTS_E5C_mag";
...
for "_i" from 1 to 3 do {this addItemToUniform "JLTS_E5C_mag";};
this addItemToUniform "ShieldGrenade_Mag";
for "_i" from 1 to 12 do {this addItemToBackpack "JLTS_E5C_mag";};

...
this addWeapon "OPTRE_M6GGNR";
this addSecondaryWeaponItem "OPTRE_SpLaser_Battery_Launcher";
...
for "_i" from 1 to 2 do {this addItemToBackpack "OPTRE_SpLaser_Battery_Launcher";};

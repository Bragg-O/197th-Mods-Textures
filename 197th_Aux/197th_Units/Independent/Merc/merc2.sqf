...
this addSecondaryWeaponItem "OPTRE_M41_Twin_HEAT";
...
for "_i" from 1 to 3 do {this addItemToBackpack "OPTRE_M41_Twin_HEAT";};
this addItemToBackpack "OPTRE_M41_Twin_HEAT_Thermal";

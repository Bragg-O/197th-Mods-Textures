...
if (hasInterface) then {
	...
	if (isNil "CIM_ActivatedAddons") exitWith {
		hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#ff0000'>ERROR</t>"];
	...
	hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#8E44AD'>LOADING</t>"];
	sleep 1;
	_errorAddons = [];
	_realerrorAddons = [];
	_activatedAddons = [];
	...
	hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#8E44AD'>LOADING</t><br/><br/>Vérification des addons requis<br/><t color='#8E44AD'>PENDING</t>"];
	sleep 1;
	if (count _activatedAddons < count CIM_ActivatedAddons) exitWith {
		hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#28B463'>OK</t><br/><br/>Vérification des addons requis<br/><t color='#ff0000'>ERROR</t>"];
		diag_log format ["[197th/fn_checkAddonsLoaded] ERROR - Activated client addons is not equal to server addons"];
		diag_log format ["[197th/fn_checkAddonsLoaded] ----------- End %1 -----------", profileName];

		if (isServer) exitWith {};
		cutText [format["<img image='\197th_Script\Data\Error_ca.paa' size='6'/><br/><br/><t size='1.5' color='#FF0000'>Vous avez %1 addons manquants.</t><br/>Télécharger le Preset depuis notre site et assurez-vous de les activer correctement.<br/><br/>Pour réinstaller le preset, veuillez visiter le lien suivant :<br/><a href='https// 197th.fr/installation'>www.197th.fr/installation</a>", ((count CIM_ActivatedAddons) - (count _activatedAddons))], "BLACK", -1, true, true];
		while { true } do {
			playSound "AlarmCar";
			sleep 4;
		};
	...
	if (count _realerrorAddons == 0) exitWith {
		hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#28B463'>OK</t><br/><br/>Vérification des addons requis<br/><t color='#28B463'>OK</t><br/><br/>Vérification des addons WhiteList<br/><t color='#28B463'>OK</t>"];
		diag_log format ["[197th/fn_checkAddonsLoaded] All Activated client addons are allow"];
		diag_log format ["[197th/fn_checkAddonsLoaded] ----------- End %1 -----------", profileName];
	};
	hint parseText format ["<img size='5' image='\197th_Script\Data\Logo197th_ca.paa'/><br/><t size='1.5' color='#F1C40F'>Chargement des addons</t><br/><t color='#28B463'>OK</t><br/><br/>Vérification des addons requis<br/><t color='#28B463'>OK</t><br/><br/>Vérification des addons WhiteList<br/><t color='#FF0000'>ERROR</t>"];
	diag_log format ["[197th/fn_checkAddonsLoaded] ERROR - Activated client addons is not equal to server addons"];
	...
	diag_log format ["[197th/fn_checkAddonsLoaded] ----------- End %1 -----------", profileName];
	if (isServer) exitWith {};
	cutText [format["<img image='\197th_Script\Data\Error_ca.paa' size='6'/><br/><br/><t size='1.5' color='#FF0000'>Vous avez %1 addons qui ne sont pas autorisés</t><br/>Télécharger le Preset depuis notre site et assurez-vous de les activer correctement.<br/><br/>Pour réinstaller le preset, veuillez visiter le lien suivant :<br/><a href='https// 197th.fr/installation'>www.197th.fr/installation</a>", (count _realerrorAddons)], "BLACK", -1, true, true];
	while { true } do {
		playSound "AlarmCar";
		sleep 4;
	};

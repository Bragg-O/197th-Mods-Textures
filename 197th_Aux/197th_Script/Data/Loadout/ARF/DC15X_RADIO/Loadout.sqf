...
for "_i" from 1 to 5 do {_units addItemToBackpack "3AS_SmokeBlue";};
for "_i" from 1 to 10 do {_units addItemToBackpack "3AS_SmokeGreen";};
for "_i" from 1 to 10 do {_units addItemToBackpack "3AS_SmokeRed";};
for "_i" from 1 to 5 do {_units addItemToBackpack "3AS_SmokeWhite";};
for "_i" from 1 to 10 do {_units addItemToBackpack "ACE_HandFlare_Green";};

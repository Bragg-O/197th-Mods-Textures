...
for "_i" from 1 to 6 do {_units addItemToVest "197th_DC17SA_mag";};
for "_i" from 1 to 3 do {_units addItemToVest "3AS_SmokeWhite";};
for "_i" from 1 to 2 do {_units addItemToVest "3AS_ThermalDetonator";};
for "_i" from 1 to 2 do {_units addItemToVest "3AS_SmokeGreen";};
for "_i" from 1 to 2 do {_units addItemToVest "3AS_SmokeBlue";};
for "_i" from 1 to 2 do {_units addItemToVest "3AS_SmokeRed";};
_units addHeadgear "197th_HelmetPilot_Regs_Pilot";

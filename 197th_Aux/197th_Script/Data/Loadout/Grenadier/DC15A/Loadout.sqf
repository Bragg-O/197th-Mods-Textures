...
_units addVest "197th_Vest_Regs_6";
_units addBackpack "197th_Backpack_Regs_Trooper";
...
for "_i" from 1 to 10 do {_units addItemToBackpack "3AS_ThermalDetonator";};
for "_i" from 1 to 15 do {_units addItemToBackpack "3AS_SmokeWhite";};
for "_i" from 1 to 5 do {_units addItemToBackpack "JLTS_grenade_emp_mag";};
for "_i" from 1 to 15 do {_units addItemToBackpack "1Rnd_HE_Grenade_shell";};
for "_i" from 1 to 15 do {_units addItemToBackpack "ACE_40mm_Flare_white";};

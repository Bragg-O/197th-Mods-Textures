...
_units addWeapon "197th_RPS6_Regs";
_units addSecondaryWeaponItem "197th_AT_mag";
...
_units addBackpack "197th_Backpack_Regs_Rocket";
...
for "_i" from 1 to 8 do {_units addItemToBackpack "197th_AT_mag";};
for "_i" from 1 to 4 do {_units addItemToBackpack "197th_HE_mag";};

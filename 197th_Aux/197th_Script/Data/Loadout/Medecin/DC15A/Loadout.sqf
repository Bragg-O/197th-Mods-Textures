...
for "_i" from 1 to 10 do {_units addItemToBackpack "ACE_epinephrine";};
for "_i" from 1 to 20 do {_units addItemToBackpack "ACE_morphine";};
for "_i" from 1 to 15 do {_units addItemToBackpack "ACE_splint";};
...
for "_i" from 1 to 10 do {_units addItemToBackpack "ACE_bloodIV";};
for "_i" from 1 to 10 do {_units addItemToBackpack "ACE_bloodIV_500";};
for "_i" from 1 to 10 do {_units addItemToBackpack "ACE_bloodIV_250";};
_units addItemToBackpack "ACE_personalAidKit";

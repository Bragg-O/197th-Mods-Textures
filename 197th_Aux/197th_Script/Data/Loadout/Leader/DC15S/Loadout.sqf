...
_units addItemToUniform "197th_DC17SA_mag";
_units addItemToVest "197th_NVG_Regs_Headlamp";
for "_i" from 1 to 2 do {_units addItemToVest "ACE_IR_Strobe_Item";};
for "_i" from 1 to 2 do {_units addItemToVest "197th_DC17SA_mag";};
for "_i" from 1 to 5 do {_units addItemToVest "3AS_SmokeWhite";};
for "_i" from 1 to 3 do {_units addItemToVest "3AS_ThermalDetonator";};
for "_i" from 1 to 8 do {_units addItemToVest "197th_DC15S_mag";};

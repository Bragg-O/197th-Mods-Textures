...
_units addVest "197th_Vest_Regs_4";
_units addBackpack "197th_Backpack_Regs_Complete";
...
for "_i" from 1 to 3 do {_units addItemToBackpack "197th_riot_shield_item";};
for "_i" from 1 to 10 do {_units addItemToBackpack "3AS_SonicDet";};

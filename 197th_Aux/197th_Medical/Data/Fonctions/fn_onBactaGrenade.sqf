_this spawn {
	...
	switch (_ammo) do {
		case "197th_BactaGrenade_Ammo": {
			...
			playSound3D ["197th_Medical\Data\sounds\Bacta.ogg", _vehbacta, false, getPosASL _vehbacta, 5, 0.7, 25];

			sleep 0.5;

			if (_i == 6) then {
				playSound3D ["197th_Medical\Data\sounds\BactaExplo.ogg", _vehbacta, false, getPosASL _vehbacta, 5, 1, 40];
			};
		};

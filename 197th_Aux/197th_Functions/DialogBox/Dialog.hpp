/*
	...
	Description:
        Please do not [Copy, Modify, Plagiarize] the following content without prior authorization from its creator.
...
class RscText {
    ...
    h = 0.037;
    w = 0.3;
    colorBackground[] = {0, 0, 0, 0.8}; // Fond sombre avec transparence
    colorText[] = {1, 1, 1, 1};
    font = "PuristaMedium";
    sizeEx = 0.04;
    text = "";

...
if (isNil "_object") exitWith {
	["[197th/fnc_initVehicleServiceReArm] Missing parameter: _object"] call BIS_fnc_logFormatServer;
};
if (isNil "_position") exitWith {
	["[197th/fnc_initVehicleServiceReArm] Missing parameter: _position"] call BIS_fnc_logFormatServer;
};

/*
	...
	Description:
	Initialize the Medic trait addaction on a object
	
	Parameter(s):
	0: Object
	
	Example:
	[this] call CIM_fnc_initUnitTraitMedic;
*/
...
if (isNil "_object") exitWith {
	diag_log format ["[197th/fnc_initUnitTraitMedic] Missing parameter: _object"];
};

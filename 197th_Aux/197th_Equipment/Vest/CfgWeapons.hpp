...
class 197th_Vest_Lieutenant1 : SWLB_clone_kama_armor {
	author = "197th Compagnie Chimaera";
	displayName = "[197th] Veste Lieutenant (Kama) Base";
	scope = 0;
	scopearsenal = 0;
...
class 197th_Vest_Lieutenant2 : SWLB_clone_lieutenant_armor {
	author = "197th Compagnie Chimaera";

...
if (player in cameraOn && cameraView == "External") then {
	hint parseText format["<img size='2' image='\197th_Fonctions\UnderFire\waves_ca.paa'/><br/>Communication entrante de %1<br/><t color='#FB0000' size='1.5'> Reste concentré soldat !</t>", name (leader group player)];

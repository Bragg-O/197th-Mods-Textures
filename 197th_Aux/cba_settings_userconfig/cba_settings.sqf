...
force force ace_cookoff_ammoCookoffDuration = 5;
...
force force ace_advanced_fatigue_restedSwayFactor = 0.5;
...
force force ace_fortify_timeMin = 5;
...
force force ace_medical_treatment_locationSurgicalKit = 1;
...
force force ace_medical_treatment_medicSurgicalKit = 0.8;
...
force force ace_magazinerepack_timePerAmmo = 10;
force force ace_magazinerepack_timePerBeltLink = 10;
...
// Freefall Fix
force force LEO_FFF_enableMod = true;
force force LEO_FFF_minHeight = 100;
...
force force JLTS_settings_EMP_notifyPlayer = false;

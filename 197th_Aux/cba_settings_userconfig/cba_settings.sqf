...
//
// ACE D̩g̢ts de v̩hicule avanc̩s
...
force force ace_advanced_fatigue_performanceFactor = 0.9;
...
force force ace_fortify_timeCostCoefficient = 0.75;
...
force force ace_medical_engine_damagePassThroughEffect = 0.75;
...
force force ace_medical_treatment_bandageEffectiveness = 2;
...
force force ace_medical_treatment_treatmentTimeBodyBag = 7;
...
//
// ACE Menu d'interaction
//
// ACE Noms des joueurs
...
force force ace_nametags_showPlayerNames = 5;
...
//
// ACE Simulation de la fragmentation
...
//
// ACE Surchauffe
force force ace_overheating_cookoffCoef = 0.01;
...
force force ace_overheating_jamChanceCoef = 0.01;
...
//
// ACE Trąnage d'objets et d'unit̩s
...
force force crowsza_pingbox_CBA_Setting_enabled = true;
force force crowsza_pingbox_CBA_Setting_fade_duration = 5;
force force crowsza_pingbox_CBA_Setting_fade_enabled = true;
force force crowsza_pingbox_CBA_Setting_oldLimit = 30;
force force crowsza_zeus_text_CBA_Setting_rc_helper = false;
force force crowsza_zeus_text_CBA_Setting_surrender_helper = false;
...
//
// DevourerKing Common
force force dev_cba_damageMultiplier = 1;
force force dev_cba_friendly = "[""HeadlessClient_F"", ""VirtualCurator_F"", ""B_VirtualCurator_F"", ""O_VirtualCurator_F"", ""I_VirtualCurator_F"", ""C_VirtualCurator_F""]";
...
force force grad_trenches_functions_allowShortEnvelope = false;
...
force force grad_trenches_functions_bigEnvelopeDigTime = 15;
...
force force grad_trenches_functions_decayTime = 300;
force force grad_trenches_functions_giantEnvelopeDamageMultiplier = 1;
force force grad_trenches_functions_giantEnvelopeDigTime = 30;
force force grad_trenches_functions_giantEnvelopeRemovalTime = -1;
force force grad_trenches_functions_hitDecayMultiplier = 0.2;
force force grad_trenches_functions_LongEnvelopeDigTime = 45;
force force grad_trenches_functions_LongEnvelopeRemovalTime = -1;
force force grad_trenches_functions_playersInAreaRadius = 10;
force force grad_trenches_functions_shortEnvelopeDamageMultiplier = 2;
force force grad_trenches_functions_shortEnvelopeDigTime = 5;
...
force force grad_trenches_functions_smallEnvelopeDigTime = 10;
...
force force grad_trenches_functions_timeoutToDecay = 300;
force force grad_trenches_functions_vehicleEnvelopeDamageMultiplier = 1;
force force grad_trenches_functions_vehicleEnvelopeDigTime = 45;
...
force force JLTS_settings_Debug_mainSwitch = 0;
force force JLTS_settings_Debug_rpt = true;
//
...
force force JLTS_settings_jumppack_mainSwitch = 1;
force force JLTS_settings_jumppack_stances = 1;
//
// JLTS - Weapons
force force JLTS_settings_Common_dropShield = true;
force force JLTS_settings_EMP_EMPEffectScope = 1;
force force JLTS_settings_EMP_mainSwitch = 1;
force force JLTS_settings_EMP_notifyPlayer = true;
...
force force IMS_ForceKillFriendlies = false;
force force IMS_LightSabers_GlobalDamageKnight = "100";
force force IMS_LightSabers_GlobalDamageMaster = "150";
force force IMS_LightSabers_GlobalDamagePadawan = "50";
force force IMS_LightSabers_Mana_Knight = "0.00012";
force force IMS_LightSabers_Mana_Master = "0.00018";
force force IMS_LightSabers_Mana_Padawan = "0.00008";
//
// Necroplague
force force dev_cba_infection = true;
force force dev_cba_infection_prolongTime = 900;
force force dev_cba_infection_resurrectAmugusChance = 0;
force force dev_cba_infection_resurrectParasiteChance = 0.1;
force force dev_cba_infection_resurrectTime = "[25,30,35]";
force force dev_cba_infection_resurrectWebknight = true;
force force dev_cba_infection_resurrectZombie = true;
force force dev_cba_infection_totalTime = 180;
//
...
//
// Necroplague - Stalker
force force dev_form939_attack_damageMan = 0.5;
force force dev_form939_attack_reachMan = 5;
force force dev_form939_distance_agro = 100;
force force dev_form939_distance_hunt = 1400;
force force dev_form939_distance_max = 1500;
force force dev_form939_distance_roam = 75;
//
...
force force OPTRE_MJOLNIR_ALLOW_LOWLIGHT_SETTING = true;
force force OPTRE_MJOLNIR_ALLOW_TARGETING_SETTING = true;
force force OPTRE_MJOLNIR_CAMSHAKE = true;
...
force force OPTRE_MJOLNIR_ENERGY_BAR_ACTIVE = true;
force force OPTRE_MJOLNIR_HUD_ACTIVE_INTRO = true;
...
force force OPTRE_MJOLNIR_OVERWRITE_CONFIG_SHIELD = false;
force force OPTRE_MJOLNIR_PREVENT_FALLDAMAGE = true;
force force OPTRE_MJOLNIR_RECOIL_MODIFIER = 0.3;
force force OPTRE_MJOLNIR_SHIELD_DELAY = 0.1;
force force OPTRE_MJOLNIR_SHIELD_ENERGY = 100;
force force OPTRE_MJOLNIR_SHIELD_ENERGY_AI = 100;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_1 = 1;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_2 = 1.5;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_3 = 2;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_4 = 2.5;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_5 = 3;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_1 = "OPTRE_FC_Elite_Armor_Minor,OPTRE_Grunt_Shield";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_2 = "OPTRE_FC_Elite_Armor_Major,OPTRE_FC_Elite_Armor_SpecOps,OPTRE_FC_Elite_Armor_Officer";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_3 = "OPTRE_FC_Elite_Armor_Ultra";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_4 = "OPTRE_FC_Elite_Armor_Zealot,OPTRE_FC_Elite_Armor_FieldMarshal";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_5 = "OPTRE_FC_Elite_Armor_HonorGuard,OPTRE_FC_Elite_Armor_HonorGuard_Ultra";
...
force force TFAR_setting_defaultFrequencies_lr_west = "30,31,32,33,34,35,36,37,38";
force force TFAR_setting_defaultFrequencies_sr_east = "";
force force TFAR_setting_defaultFrequencies_sr_independent = "";
force force TFAR_setting_defaultFrequencies_sr_west = "100,100,100,100,100,100,100,100,100";
...
force force TFAR_Teamspeak_Channel_Name = "[cspacer1] TaskForceRadio";
...
force force tsp_cba_animate_dynamicReadyFriend = 3;
force force tsp_cba_animate_dynamicReadyFriendAngle = 35;
force force tsp_cba_animate_dynamicReadyObject = 2;
force force tsp_cba_animate_dynamicReadyPoll = 0.25;
force force tsp_cba_animate_dynamicReadyVertical = -0.1;
...
force force WBK_ZommbiesLeaperHealthParam = "120";
force force WBK_ZommbiesMeleeHealthParam = "100";
force force WBK_ZommbiesSmasherHealthParam = "3500";
force force WBK_ZommbiesSmasherJumpParam = true;
force force WBK_ZommbiesSmasherThrowParam = true;
//
// Zeus Enhanced
force force zen_area_markers_editableMarkers = 0;
force force zen_building_markers_enabled = false;
...
//
// Zeus Enhanced - Attributs
//
// Zeus Enhanced - Filtre des Fractions
